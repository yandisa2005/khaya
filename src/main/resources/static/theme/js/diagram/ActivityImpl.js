var ActivityImpl = function(activityJson){
	...
	if (activityJson != undefined) {
        ...
        if(activityJson.processedDate != undefined) {
            var date = new Date(parseInt(activityJson.processedDate)).toLocaleString();
...
ActivityImpl.prototype = {
    ...
    setProcessedDate: function(processedDate){
        this.processedDate = processedDate;
    },

    getProcessedDate: function(){
