...
angular.module('jasApp')
    .controller('clientsController', ['$scope', 'ClientsFactory', function ($scope, ClientsFactory) {

        $scope.title = "** Client List ***";
        ...
        ClientsFactory.query(function (response) {
